...
class UserListEntry
{
     ...
     * ToDo.
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\ConsolesCollections", inversedBy="userListsContents")
     *
     * @ORM\JoinColumn(nullable=true)
     */
    private object $consoleCollection;
     ...
     * ToDo.
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\AccessoriesCollections", inversedBy="userListsContents")
     *
     * @ORM\JoinColumn(nullable=true)
     */
    private object $accessoryCollection;
